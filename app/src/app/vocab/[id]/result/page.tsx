    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-2xl mx-auto px-4 py-8">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">
          セット {quiz.quiz_number} - 結果
        </h1>
        {quiz.word_range && (
          <p className="text-sm text-gray-500 mb-6">単語 {quiz.word_range}</p>
        )}

        {/* 正解数 */}
        <div className="text-center py-8 mb-8 border border-gray-200 rounded-lg">
          <p className="text-5xl font-bold mb-2">
            <span className={correctCount >= questions.length / 2 ? "text-green-600" : "text-red-600"}>
              {correctCount}
            </span>
